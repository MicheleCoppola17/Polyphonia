...
class SongService {
    ...
    func addAudioIdea(to song: Song, title: String, url: URL, duration: TimeInterval, audioData: Data?) {
        let idea = AudioIdea(title: title, url: url, duration: duration, audioData: audioData)
